...
The analysis results in above have verified that our hypothesis of hateful tweets covariate has no relationship with the hate crime occurred since its coefficient is statistically insignificant. This matches with the result found in this ([\textcolor{cyan}{Williams et al., 2019}](https://academic.oup.com/bjc/article/60/1/93/5537169)) study where there is no association between online hate speech from Twitter to the hate crime. But then observed crime data have proved that hate crime did happen mostly on minority groups especially black and other races and female.
