...
In this study, we will develop two spatio-temporal Bayesian models. One obeys a Poisson distribution and another obeys Binomial distribution as below.
...
29. NYCdata. Baruch College. Available online: https://www.baruch.cuny.edu/nycdata/population-geography/age_distribution.htm
...
map <- ggplot() + 
  ...
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(
    subtitle = paste0(year, " Hate Crime & Relative Risk by Poisson Distribution")) + 
  bi_theme() + 
  theme(plot.subtitle=element_text(size=18, 
                                   hjust=0.5, 
                                   color="black"))
...
map <- ggplot() + 
  geom_sf(data = data, 
          ...
          show.legend = FALSE) +
  bi_scale_fill(pal = "GrPink", dim = 3) +
  labs(subtitle = paste0(year, " Hate Crime & Relative Risk by Binomial Distribution")) + 
  bi_theme() + 
  theme(plot.subtitle=element_text(size=18, 
                                   hjust=0.5, 
                                   color="black"))
